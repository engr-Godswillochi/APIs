...
namespace BookTrackApi.Migrations
{
    ...
    [Migration("20250131221250_MakeReviewRatingNullableAndAddType")]
    partial class MakeReviewRatingNullableAndAddType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookTrackApi.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookTrackApi.Models.Collection", b =>
                {
                    b.HasOne("BookTrackApi.Models.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookTrackApi.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
